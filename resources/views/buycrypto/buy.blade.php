...
@section('content')
    ...
    <div class="w-5.5/6 m-auto text-center pl-8">
        <table class="px-72 rounded-md">
            ...
            <tbody class="bg-white">
                <tr class="whitespace-nowrap py-4"> 
                    <td class="py-4">
                        <div class="text-sm text-gray-900">
                            <img class="h-8 w-40" src="https://www.nerdwallet.com/cdn-cgi/image/quality=85/cdn/investing/logos/ftxus.png">
                        </div>
                    </td>
                    <td class="px-6 py-4">
                        <div class="text-sm text-gray-900">
                    ...
                    <td class="px-6 py-4">
                        <div class="text-sm text-gray-900 text-left">
                            <a href="https://ftx.com/" class="bg-blue-500 hover:bg-blue-700 text-white text-center py-2 px-4 rounded">
                                Learn More
                            </a>
                ...
                <tr class="whitespace-nowrap py-4"> 
                    <td class="py-4">
                        <div class="text-sm text-gray-900">
                            <img class="h-8 w-40" src="https://www.nerdwallet.com/cdn-cgi/image/quality=85/cdn/investing/logos/Coinbase_Wordmark.png">
                        </div>
                    </td>
                    <td class="px-6 py-4">
                        <div class="text-sm text-gray-900">
                    ...
                    <td class="px-6 py-4">
                        <div class="text-sm text-gray-900 text-left">
                            <a href="https://www.coinbase.com/" class="bg-blue-500 hover:bg-blue-700 text-white text-center py-2 px-4 rounded">
                                Learn More
                            </a>
                ...
                <tr class="whitespace-nowrap py-4"> 
                    <td class="py-4">
                        <div class="text-sm text-gray-900">
                            <img class="h-8 w-40" src="https://www.nerdwallet.com/cdn-cgi/image/quality=85/cdn/investing/logos/gemini.png">
                        </div>
                    </td>
                    <td class="px-6 py-4">
                        <div class="text-sm text-gray-900">
                    ...
                    <td class="px-6 py-4">
                        <div class="text-sm text-gray-900 text-left">
                            <a href="https://www.gemini.com/eu" class="bg-blue-500 hover:bg-blue-700 text-white text-center py-2 px-4 rounded">
                                Learn More
                            </a>
                ...
                <tr class="whitespace-nowrap py-4"> 
                    <td class="py-4">
                        <div class="text-sm text-gray-900">
                            <img class="h-14 w-40" src="https://www.nerdwallet.com/cdn-cgi/image/quality=85/cdn/investing/logos/etoro_logo.png">
                        </div>
                    </td>
                    <td class="px-6 py-4">
                        <div class="text-sm text-gray-900">
                    ...
                    <td class="px-6 py-4">
                        <div class="text-sm text-gray-900 text-left">
                            <a href="https://www.etoro.com/crypto/exchange/" class="bg-blue-500 hover:bg-blue-700 text-white text-center py-2 px-4 rounded">
                                Learn More
                            </a>
                ...
                <tr class="whitespace-nowrap py-4"> 
                    <td>
                        <div class="text-sm text-gray-900">
                            <img class="h-8 w-40" src="https://www.nerdwallet.com/cdn-cgi/image/quality=85/cdn/investing/logos/Kraken.png">
                        </div>
                    </td>
                    <td class="px-6 py-4">
                        <div class="text-sm text-gray-900">
                    ...
                    <td class="px-6 py-4">
                        <div class="text-sm text-gray-900 text-left">
                            <a href="https://www.kraken.com/" class="bg-blue-500 hover:bg-blue-700 text-white text-center py-2 px-4 rounded">
                                Learn More
                            </a>
