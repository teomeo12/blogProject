...
@section('content')
    <div class="background-image grid grid-cols-1 m-auto">
        <div class="flex text-gray-100 pt-10">
            <div class="m-auto pt-4 pb-16 sm:m-auto w-4/5 block text-center">
                ...
                <a href="/blog" {{-- class=" rounded-3xl text-center bg-gray-50 text-gray-700 md-2 py-3 px-4 font-bold text-xl uppercase" --}}
    ...
    $myCoins_array = ['BTC', 'ETH', 'DOGE', 'SHIB', 'USDT', 'BNB', 'USDC', 'XRP', 'SOL', 'ADA'];
    ...
    $parameters = ['symbol' => $myCoins_list];
    $headers = ['Accepts: application/json', 'X-CMC_PRO_API_KEY: ' . $myAPIKey];
    ...
    <div class="sm:grid grid-cols-2 gap-20 w-4/5 mx-auto py-5 border-b  border-t border-gray-300">
        ...
        <div>
            <img class="rounded-md hover:drop-shadow-[0_5px_5px_rgba(0,0,0,20)]	" src="./images/cryptocurrency.jpg"
                width="700" alt="">
        </div>
        ...
        <div class="m-auto sm:m-auto text-left w-4/5 block">
            ...
            <p class="py-8 text-gray-500 text-s">
                Crypto Guru started with sole focus on educating its readers about Bitcoin and its potential impact on the
                traditional financial systems has grown with the cryptocurrency industry to cover various altcoins,
                blockchain projects, crowdsales, regulatory developments and the futuristic confluence of some of the
                leading technologies of time viz., blockchain, artificial intelligence, internet of things and more.
            </p>
    ...
    <div class="text-center py-15">
        ...
        <p class="m-auto w-4/5 text-gray-500 pb-10">
            It is always important to be in tune with the latest news. To have the latest news means to be the first in
            making meaningful choices and to know everything significant before your competitors do. Our latest news on
            cryptocurrency is the best source to rely on while deciding on trading strategies and investment options. Read
            the latest news on blockchain and cryptocurrency
        </p>
    </div>
    ...
    <div class="sm:grid grid-cols-2 w-4/5 m-auto flex-row">
        <div class="flex bg-gray-800 text-gray-100 pt-10 rounded-md mx-5 hover:drop-shadow-[0_5px_5px_rgba(0,0,0,20)] ">
            <div class="m-auto pt-4 pb-16 sm:m-auto w-4/5 block ">
                ...
                <h3 class="text-xl font-bold py-10">
                    ...
                    central issuing or regulating authority, instead using a decentralized system to record transactions and
                    issue new units.
                </h3>

                <a href="/blog/what-is-cryptocurrency"
        ...
        <div class="flex bg-gray-800 text-gray-100 pt-10 pl-3   rounded-md hover:drop-shadow-[0_5px_5px_rgba(0,0,0,20)]">
            <div class="m-auto pt-4 pb-16 sm:m-auto w-4/5 block">
                ...
                <div>
                    <div class="w4/5 my-2">
                        <img class="rounded-md hover:drop-shadow-[0_5px_5px_rgba(192,192,192)] w-20 h-20	"
                            src="./images/nft.jpg" alt="">
                    </div>
                ...
                <h3 class="text-xl font-bold py-10">
                    ...
                    They are bought and sold online, frequently with cryptocurrency, and they are generally encoded with the
                    same underlying software as many cryptos.
                </h3>

                <a href="/blog/non-fungible-tokens-explained"
